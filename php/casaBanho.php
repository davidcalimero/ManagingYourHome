								...
								<tr id="corpo"><td>	
                                    <div id="submainDivision"> 
                                        <div class="itemContainer">
                                            ...
                                            <div onClick="verificaPermissao('wl1','eID');" id="wl1"><img style="width: 100%; height: 81%" src="../media/img/square.png"/></div>        
                                        </div>
                                    </div>
								...
								<form name="changeForm">
									<table class="editTable" border="0" width="100%">
										...
										<tr><td colspan="2" class="loginButtons">
											<input type="button" name="alterarDivisao" value="Guardar" id="saveAD" class="loginButtons" onclick="saveEdit('casaBanho','acede','dID');"/> 
											<input type="reset" name="cancelar" value="Repor" id="cancelAD" class="loginButtons" onclick="cancelEdit('casaBanho','acede','dID');"/>
										</td></tr>
									</table>
								</form>
